...
#             price_of_electricity=np.full(n, 1e-7)
#         )
...
#             price_of_electricity=np.full(10, 1e-7)
#         )
...
class TestComputeSingleCombination:
    ...
    def test_compute_single_combination_basic(self):
        ...
        input_arrays = [
            ...
            np.array([1e-7])    # price_of_electricity
        ]
...
class TestPhysicalConstraints:
    ...
    def test_startup_time_with_breeding_ratio(self):
        ...
        result_low = lump_solver(
            ...
            I_target=10.0, eta_th=0.4, capacity_factor=0.8, price_of_electricity=1e-7,

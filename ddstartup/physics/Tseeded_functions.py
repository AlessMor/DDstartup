...
def ode_system(t: float, y: np.ndarray, 
               ...
               injection_rate_max: float, N_st_min: float) -> np.ndarray:
    """
    ...
    - N_st: Storage tritium inventory (atoms)
    ...
    **Unified Interface**: Similar signature to lump_solver for easier orchestration.
    ...
    Returns:
        Dictionary with keys:
            ...
            - N_ofc: Out-of-fuel-cycle tritium (atoms) - ARRAY
    ...
    """
    # Get registry for result dictionary creation
    ...
    def dt_reached_event(t: float, y: np.ndarray) -> float:
        """Trigger when tritium reaches 50% (DT equilibrium)"""
